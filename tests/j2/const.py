...
from pykg2tbl.j2.jinja_sparql_builder import TEMPLATES_FOLDER

file_system_loader = FileSystemLoader(TEMPLATES_FOLDER)
...
template_variables = {
    ...
    "broader-terms.sparql": set({"triple", "language"}),
